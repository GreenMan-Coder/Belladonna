        ...
        {services.map((service, index ) => {
            return <ul key={index}>
                    ...
                    <article className="contact">
                        <p>¡Únete a nuestra comunidad y no dudes en hacernos cualquier pregunta que tengas! Estaremos encantados de ayudarte en lo que necesites.</p>
                        <div className="nets">
                    ...
                    <article className="reserve">
                        <p>¡No te quedes sin tu cita! Reserva ahora mismo y disfruta de nuestros servicios. ¡Te esperamos!</p>
