...
const Description = ({sub, title, paragraph, href, pad}) => {
  return <div className="container">
    ...
    { title === "Depilación con cera" ? <div className="nets">
      <SocialNetworks marg="0" tam="8%" href="https://www.facebook.com/profile.php?id=100074125141678&mibextid=ZbWKwL">
      ...
      <SocialNetworks marg="8px" tam="7.4%" href="https://instagram.com/belladonna_depilacion?igshid=ZDdkNTZiNTM=">
