...
const HoWork = ({row}) => {
  return <section className="container">
    <div className="resources">
      ...
      <ResourcesCard url="url(/img/front-page/folow.jpeg)" tam="150%" title="SEGUIMIENTO" text="Post depilación, mantendremos contacto contigo para verificar la evolución de la piel y estar al tanto de cualquier consulta adicional que puedas tener." pos="center" top="9px"/>
