    ...
    return <section className="container">
        ...
        <form action="#" method="post" id="contact_form">
            <div className="name">
                ...
                <input type="text" placeholder="¿Tu nombre o empresa?" name="name" id="name_input" required/>
            </div>
            <div className="email">
            ...
            <div className="subject">
                ...
                <select name="subject" id="subject_input" required>
                    ...
                    <option>Referente al servicio de depilación</option>
                    <option>Referente a la bisutería</option>
                    <option>Referente a la comunidad</option>
                    <option>Otro</option>
                </select>
            </div>
            <div className="message">
                <label for="message"></label>
                <textarea name="message" placeholder="Déjame tu mensaje" id="message_input" cols="30" rows="5" required></textarea>
            </div>
